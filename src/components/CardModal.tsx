      ...
      >
                ...
                {DEFAULT_LABELS.map(label => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-xs text-white px-3 py-1 rounded-full font-medium transition-all ${
        ...
        <div className="flex items-center justify-between p-6 mt-2">
          <button
            ...
            className="text-sm text-red-500 hover:text-red-700 hover:bg-red-50 px-3 py-1.5 rounded transition-colors"
          >
            Delete Card
          </button>
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="text-sm text-gray-600 hover:text-gray-800 px-4 py-1.5 rounded transition-colors"
            >
              Cancel
            </button>
            <button
              onClick={handleSave}
              className="text-sm bg-blue-500 text-white px-4 py-1.5 rounded hover:bg-blue-600 transition-colors"
            >
              Save
            </button>
          </div>
